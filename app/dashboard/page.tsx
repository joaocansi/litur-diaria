    ...
    return (
        <div className="flex flex-col justify-between items-center min-h-screen w-11/12 mx-auto">
            <header className="pt-6 pb-6 w-full text-center">
                <h1 className="text-4xl font-extrabold text-amber-800">Liturgia Diária</h1>
                <p className="text-base text-amber-700 mt-2">Reflexões inspiradoras para enriquecer sua jornada espiritual</p>
            </header>
